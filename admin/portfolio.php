...
$queryPort = mysqli_query($koneksi, "SELECT * FROM portfolio");

if (isset($_GET['delete'])) {
    $id = $_GET['delete']; //mengambil nilai param

    //query / perintah hapus
    $delete = mysqli_query($koneksi, "DELETE FROM portfolio WHERE id ='$id'");
    header("location:portfolio.php?hapus=berhasil");
}
?>
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h5 class="m-b-10">Portofolio Settings Page</h5>
                            </div>
                            <ul class="breadcrumb">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div align="right" class="mb-3">
                                <a href="tambah-portfolio.php" class="btn btn-primary">Tambah</a>
                            </div>
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <?php $no = 1;
                                    while ($rowPort = mysqli_fetch_assoc($queryPort)) : ?>
                                        <tr>
                                            <td><?php echo $no++ ?></td>
                                            ...
                                            <td>
                                                ...
                                                <a onclick="return confirm('Apakah anda yakin akan menghapus data ini??')" href="portfolio.php?delete=<?php echo $rowPort['id'] ?>" class="btn btn-danger btn-sm">

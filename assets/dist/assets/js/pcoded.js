...
function layout_change(layout) {
  ...
  if (layout == 'dark') {
    ...
    dark_flag = false;
    if (document.querySelector('.pc-sidebar .m-header .logo-lg')) {
      document.querySelector('.pc-sidebar .m-header .logo-lg').setAttribute('src', '../assets/dist/assets/images/logo-dark.svg');
    }
    if (document.querySelector('.navbar-brand .logo-lg')) {
      document.querySelector('.navbar-brand .logo-lg').setAttribute('src', '../assets/dist/assets/images/logo-dark.svg');
    }
    if (document.querySelector('.navbar-brand .brand-logo')) {
      document.querySelector('.navbar-brand .brand-logo').setAttribute('src', '../assets/dist/assets/images/logo-dark.svg');
    }
    if (document.querySelector('.auth-main .brand-logo')) {
      document.querySelector('.auth-main .brand-logo').setAttribute('src', '../assets/dist/assets/images/logo-dark.svg');
    }
    if (document.querySelector('.footer-top .footer-logo')) {
      document.querySelector('.footer-top .footer-logo').setAttribute('src', '../assets/dist/assets/images/logo-dark.svg');
    }
    var control = document.querySelector('.theme-layout .btn.active');
    if (control) {
      document.querySelector('.theme-layout .btn.active').classList.remove('active');
